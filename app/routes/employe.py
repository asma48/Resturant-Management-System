...
employe_setting_router  = APIRouter(
    prefix = "/setting",
    tags = ["Account Settings"]
)
@employe_setting_router.get('/')
def current_employe(db: db_session,current_employe: Annotated[dict, Depends(get_current_employe)]):
...
@employe_setting_router.get("/list_of_employes")
...
@employe_setting_router.put('/update/{id}')
...
@employe_setting_router.delete("/delete employe")
